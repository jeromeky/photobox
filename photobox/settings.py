...
MEDIA_ROOT = '/usr/local/Django-1.5/photobox/gallery/media/'
...
MEDIA_IMAGES = '/usr/local/Django-1.5/photobox/gallery/media/normal/'

MEDIA_IMAGES_THUMBNAIL = '/usr/local/Django-1.5/photobox/gallery/media/thumbnail/'
